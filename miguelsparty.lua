tfm.exec.newGame(6715055)
tfm.exec.setNameColor("Miguelpopiu",0xFFFFFF)
tfm.exec.setNameColor("Lion33",0xFFFFFF)
tfm.exec.setUIMapName("Feathers")
tfm.exec.setGameTime(8000,true)

function eventLoop(timeRemaining,timeRemaining)

  imax = tfm.get.room.playerList.Miguelpopiu.x
  imay = tfm.get.room.playerList.Miguelpopiu.y
  ...
  dedx = tfm.get.room.playerList.Lion33.x
  dedy = tfm.get.room.playerList.Lion33.y
...
function eventEmotePlayed(name, id)
  if id==3 and name=="Miguelpopiu" then
    tfm.exec.displayParticle(10,tfm.get.room.playerList.Miguelpopiu.x,tfm.get.room.playerList.Miguelpopiu.y-30,0,0,0,0,nil)
  end
  if id==3 and name=="Lion33" then
    tfm.exec.displayParticle(10,tfm.get.room.playerList.Lion33.x,tfm.get.room.playerList.Lion33.y-30,0,0,0,0,nil)
  end
end
